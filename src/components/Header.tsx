...
import { NAV_LINKS, WHATSAPP_DISPLAY, ENDERECO, CIDADE } from "@/lib/constants";
      ...
      >
        ...
        >
          <div className="flex items-center justify-center gap-4">
            ...
            <WhatsAppLink
              message="Olá! Gostaria de falar pelo WhatsApp."
              section="Menu mobile - CTA"
              addPathname
