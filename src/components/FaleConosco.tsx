import { WHATSAPP_DISPLAY, EMAIL, ENDERECO, CIDADE, CEP, getWhatsAppHref } from "@/lib/constants";
...
const CONTACTS = [
  {
    ...
    href: getWhatsAppHref({ mensagem: "Olá! Gostaria de mais informações.", secao: "Fale Conosco - Card" }),
    external: true,
  },
  {
    icon: "✉️",
    ...
    <section id="contato" style={{ background: "#EAF0F6" }}>
      <div className="section">
        ...
        <div className="mt-12 text-center">
          <WhatsAppLink message="Olá! Gostaria de agendar uma consulta gratuita." section="Fale Conosco" addPathname className="btn-wa">
